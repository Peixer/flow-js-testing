...
> ⚠️ **Required:** Your project must follow the [required structure](structure) and it must be [initialized](https://docs.onflow.org/flow-js-testing/init) to use the following functions.
...
| `addressMap` | [AdressMap](/flow-js-testing/docs/api#addressmap)                      | ✅       | (optional) object to use for address mapping of existing deployed contracts                                                                     |
...
| `addressMap`   | [AdressMap](/flow-js-testing/docs/api#addressmap)                                               | ✅       | object to use for import resolver. Default: `{}`                                                                                     |
