...
| ---- | --------------------------- | ---------------------------------------------------- |
| `ix` | [Interaction](api#interaction)  | interaction, either in form of a Promise or function |
...
| Name | Type                        | Description                                          |
| ---- | --------------------------- | ---------------------------------------------------- |
| `ix` | [Interaction](api#interaction) | transaction, either in form of a Promise or function |
